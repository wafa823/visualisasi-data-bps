...
def apply_custom_css(theme: str):
    """Terapkan semua CSS kustom berdasarkan tema (Dark Mode atau Light Mode)."""
    if theme == "Light Mode":
        st.markdown("""
        <style>
            ...
            /* Paksa background utama Light Mode */
            .stApp {
                background: #f8fafc !important;
            }

            /* ── HTML Metric Cards (Terang) ── */
            .metric-card {
            ...
            .metric-card-blue   { border-top: 3px solid #2563eb !important; }
            .metric-card-green  { border-top: 3px solid #16a34a !important; }
            .metric-card-orange { border-top: 3px solid #ea580c !important; }
            .metric-card-purple { border-top: 3px solid #7c3aed !important; }
            ...
            [data-testid="stSidebar"] h2 { color: #1e3a8a !important; letter-spacing: 0.02em; }
            [data-testid="stSidebar"] h3 { color: #2563eb !important; font-size: 0.9rem; }
            ...
            .section-label {
                ...
                color: #2563eb !important; text-transform: uppercase; margin-bottom: 10px;
            }

            /* ── Download button (Terang) ── */
            [data-testid="stDownloadButton"] > button {
                background: linear-gradient(135deg, #f8fafc, #f1f5f9) !important;
                color: #1e293b !important; border: 1px solid #cbd5e1 !important;
            ...
            @keyframes pulseGlow {
                ...
                50%       { text-shadow: 0 0 8px rgba(37,99,235,0.15); }
            }
